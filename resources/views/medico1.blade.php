            ...
            <div class="admin-wrapper">
                ...
                <div class="left-sidebar">
                    ...
                    <li><a href="{{route('medico', session('usuario')['usuario'])}}">Pendentes</a></li>
                       ...
                       <strong><li><a style="text-transform: uppercase;" href="{{route('medico-atendidas', session('usuario')['usuario'])}}">Atendidas</a></li></strong>
                    </ul>
                </div>
               ...
               <div class="admin-content">
                    ...
                    <div class="admin-content">
                                    ...
                                    <div class="content">
                                        <h2 class="pag-title">Minhas consultas atendidas</h2>
                                    ...
                                    @else
                                        <table>
                                            <thead>
                                                ...
                                                <th>MORADA</th>
                                                <th>IDADE</th>
                                                <th colspan="4">DATA E HORA DO ATENDIMENTO</th>
