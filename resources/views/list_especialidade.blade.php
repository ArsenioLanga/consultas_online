...
<div class="left-sidebar">
    <ul>
        ...
        <strong><li><a style="text-transform: uppercase;" href="{{route('crud_especialidades')}}">Especialidades</a></li></strong>
...
<div class="admin-content">
    ...
    <div class="content">
       <div class="admin-content">
                    ...
                    <div class="content">
                        <h2 class="pag-title">Todas especialidades</h2>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$especialidade->unidade_id}}</td>
                                    <td><a href="{{route('consulta_edit', $especialidade->id)}}"  class="btn btn-primary">Editar</a></td>
                                    <td><a href="{{route('cancelar_edit', $especialidade->id)}}" class="btn btn-danger">Desabilitar</a></td>
