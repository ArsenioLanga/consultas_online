...
<div class="admin-content">
    ...
    <div class="content">
        <div style="color: red; text-align: center; background-color: #00ca65 ">
            <h3>Medico indisponivel na data e hora selecionadas</h3>
        </div>
       <h2 class="pag-title">Marcação de Consultas Online</h2>
        ...
        @csrf
            <div class="tab">
                ...
                <input type="text" placeholder="Nome do Paciente" disabled="true" oninput="this.className = ''" name="nome"  value="Maria">
                <input type="number" placeholder="Idade do Paciente" disabled="true" oninput="this.className = ''" name="idade" value="10">
                <input type="text" placeholder="Morada do Paciente" disabled="true" oninput="this.className = ''" name="morada" value="Matola">
                Masc:&nbsp; <input type="radio" value="M"  oninput="this.className = ''" name="sexo" selected>&nbsp;
